...
const SIDEBAR_WIDTH_STORAGE_KEY = "myko.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "myko.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "myko.sidebar.collapsed";
