...
export const DEFAULT_THEME_ID = "myko-default";
...
const STORE_PATH = "myko-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "myko://prefs-changed";
...
const KEYS_CHANGED_EVENT = "myko://ai-keys-changed";
